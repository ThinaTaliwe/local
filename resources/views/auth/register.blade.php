    ...
    <main class="main-content  mt-0">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-group input-group-dynamic mb-3">
                ...
                <input id="name" type="text"  name="name" value="{{old('name')}}" class="form-control" aria-label="Name" placeholder="Name" required autofocus >
            </div>
            ...
            <div class="input-group input-group-dynamic mb-3">
                ...
                <input id="email" type="email"  name="email" value="{{old('email')}}" class="form-control" placeholder="Email" aria-label="Email">
            </div>
